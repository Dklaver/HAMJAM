...
public class Heatmap : MonoBehaviour
{
    ...
    public Vector4[] HeatPoints { get; private set; }
    public float HeatRadius => material.GetFloat("_HeatRadius");
...
{
    float[] hits = new float[32 * 4];
    HeatPoints = new Vector4[critPoints];
